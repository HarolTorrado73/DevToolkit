...
import { formatXml, minifyXml, validateXml } from "@/tools/xml-formatter/lib";
...
export default function XmlFormatterTool() {
  ...
  function applyResult(
    result: ReturnType<typeof formatXml>,
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap gap-2">
        <Button
          type="button"
          onClick={() => applyResult(formatXml(input), "Formatted XML.")}
        >
          Format
        </Button>
        <Button
          type="button"
          variant="secondary"
          onClick={() => applyResult(minifyXml(input), "Minified XML.")}
        >
          Minify
        </Button>
        <Button
          type="button"
          variant="outline"
          onClick={() => applyResult(validateXml(input), "XML is valid.")}
        >
          Validate
        </Button>
        <Button
